...
//
//*****************************************************************************
//static const USART_TypeDef * UARTBase[3] =
//{
...
//*****************************************************************************
void
UARTStdioConfig(USART_TypeDef *USARTx, bool bDisableEcho)
{
...
void UARTStdioConfigWriteUart(USART_TypeDef *Usart, bool bDisableEcho)
{
...
void UART_SendData(USART_TypeDef *USARTx, char *buffer, uint32_t bufferSize)
{
