...
C_SRCS += \
../Core/WATCHDOG/watchdog.c 

OBJS += \
./Core/WATCHDOG/watchdog.o 

C_DEPS += \
./Core/WATCHDOG/watchdog.d 


# Each subdirectory must supply rules for building sources it contributes
Core/WATCHDOG/%.o Core/WATCHDOG/%.su Core/WATCHDOG/%.cyclo: ../Core/WATCHDOG/%.c Core/WATCHDOG/subdir.mk
...
clean: clean-Core-2f-WATCHDOG

clean-Core-2f-WATCHDOG:
	-$(RM) ./Core/WATCHDOG/watchdog.cyclo ./Core/WATCHDOG/watchdog.d ./Core/WATCHDOG/watchdog.o ./Core/WATCHDOG/watchdog.su

.PHONY: clean-Core-2f-WATCHDOG
