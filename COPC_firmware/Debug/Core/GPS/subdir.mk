...
Core/GPS/%.o Core/GPS/%.su Core/GPS/%.cyclo: ../Core/GPS/%.c Core/GPS/subdir.mk
...
clean: clean-Core-2f-GPS

clean-Core-2f-GPS:
	-$(RM) ./Core/GPS/gps.cyclo ./Core/GPS/gps.d ./Core/GPS/gps.o ./Core/GPS/gps.su

.PHONY: clean-Core-2f-GPS
