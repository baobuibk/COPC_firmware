...
Core/SYS/%.o Core/SYS/%.su Core/SYS/%.cyclo: ../Core/SYS/%.c Core/SYS/subdir.mk
...
clean: clean-Core-2f-SYS

clean-Core-2f-SYS:
	-$(RM) ./Core/SYS/sys.cyclo ./Core/SYS/sys.d ./Core/SYS/sys.o ./Core/SYS/sys.su

.PHONY: clean-Core-2f-SYS
